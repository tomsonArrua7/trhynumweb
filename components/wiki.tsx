  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        steps: [
          "Andá a la ciudad de Ullathorpe.",
          "Usa el formulario 'Retos x Canjes' que aparece en la parte inferior de la interfaz.",
          "Seleccioná a tu oponente y el monto de Puntos de Canje a apostar.",
          "El que gana se lleva el pozo de la apuesta.",
        ],
        commands: [],
        note: "Es el sistema ideal para duelos de alto riesgo.",
      },
      {
        title: "Retos 2v2 (Baldosas)",
        steps: [
          "Misma mecánica que los 1v1 en la zona de Teleports.",
          "Coordiná con tu compañero para pisar las baldosas al mismo tiempo.",
          "Trabajo en equipo y sincronización son clave.",
        ],
        commands: [],
        note: null,
      },
